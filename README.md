...
* Handy WITH FUNCTION clause for adhoc XLSX generation without deploying code: [column_format_sample.xlsx](./samples/column_format_sample.xlsx)
...
;
/
-- Toad and SqlDeveloper will let you save the blob as a file. Sqlplus a bit more work.
```
